/* Street light 1 */
#define s1_r 2  // Red LED Pin 
#define s1_y 3  // Yellow LED Pin 
#define s1_g 4  // Green LED Pin


/* Street light 2 */
#define s2_r 5  // Red LED Pin 
#define s2_y 6  // Yellow LED Pin 
#define s2_g 7  // Green LED Pin

/* Street light 3 */
#define s3_r 8  // Red LED Pin 
#define s3_y 9  // Yellow LED Pin 
#define s3_g 10  // Green LED Pin


/* Street light 4 */
#define s4_r 11 // Red LED Pin 
#define s4_y 12 // Yellow LED Pin 
#define s4_g 13 // Green LED Pin

int G1_time = 4; // set signal 1 open time
int G2_time = 6; // set signal 2 open time
int G3_time = 8; // set signal 3 open time
int G4_time = 10; // set signal 3 open time


itn Y_time = 1; //set all signal wait timw
